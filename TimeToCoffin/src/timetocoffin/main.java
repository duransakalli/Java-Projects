			...
			public void run() {
				try {
					for (;;) {
						...
						int year = (int)(Math.random() * (2070 - 2030) + 2030);
						int month = (int)(Math.random() * (12 - 1)+1);
						int day = (int)(Math.random() * (30 - 1)+1);
                                                
                                                jLabel1.setText("You will die:");
						jLabel2.setText(month + "/" + day + "/" + year);
                                                jLabel3.setText((year - yearNow) + " years " + Math.abs(month - monthNow) + " months " + Math.abs(day - dayNow) + " days left.");
						sleep(10000000);
					}
				} catch (Exception e) {
					e.printStackTrace();
